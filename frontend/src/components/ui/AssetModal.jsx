...
export default function AssetModal({ symbol, onClose }) {
  ...
  return (
    <BaseModal
      onClose={onClose}
      title={symbol}
      subtitle={data?.name || 'Asset analysis'}
          ...
          <div className="space-y-10">
            ...
            <div className="grid grid-cols-1 xl:grid-cols-3 gap-8">
              <div className="xl:col-span-2 space-y-4">
                ...
                <div className="h-[300px] min-h-[300px] w-full bg-white/[0.02] rounded-3xl border border-white/5 p-4 flex flex-col shadow-inner">
                  {pricesLoading ? (
